        ...
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
            ...
            <div className='fixed inset-0 overflow-y-auto'>
                ...
                leaveTo='opacity-0 scale-80'>
                    <DialogPanel className="relative w-full max-w-lg max-h-[80vh] overflow-y-auto transform rounded-2xl p-6 bg-white shadow-xl transition-all flex flex-col gap-5">
                        <button type="button"
